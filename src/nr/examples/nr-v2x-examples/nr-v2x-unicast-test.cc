...
main(int argc, char* argv[])
{
    ...
    // Enable PSFCH for unicast HARQ feedback (period = 4 slots)
    ...
    // Log unicast configuration for verification
    std::cout << "\n=== Sidelink Configuration Verification ===" << std::endl;
    std::cout << "Cast Type: UNICAST" << std::endl;
    std::cout << "Destination L2 ID: " << dstL2Id << std::endl;
    std::cout << "HARQ Enabled: " << (harqEnabled ? "YES" : "NO") << std::endl;
    std::cout << "PSFCH Period: 4 slots (HARQ feedback channel enabled)" << std::endl;
    std::cout << "=========================================\n" << std::endl;
